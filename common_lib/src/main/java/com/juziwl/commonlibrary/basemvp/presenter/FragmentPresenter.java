 ...
 */
public abstract class FragmentPresenter<T extends IDelegate> extends Fragment implements IPresent {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle
        ...
        viewDelegate.create(inflater, container, savedInstanceState, this);
