...
public final class KeyboardUtils {
     ...
     * @param view The view.
     */
    public static void showSoftInput(final View view,Context activity) {
        InputMethodManager imm =
     ...
     * @param view The view.
     */
    public static void hideSoftInput(final View view,Context activity) {
        InputMethodManager imm =
                (InputMethodManager) activity.getSystemService(Context.INPUT_METHOD_SERVICE);
        if (imm == null) return;
        imm.hideSoftInputFromWindow(view.getWindowToken(), 0);
     ...
     */
    public static void toggleSoftInput(Context activity) {
        InputMethodManager imm =
                (InputMethodManager)activity.getSystemService(Context.INPUT_METHOD_SERVICE);
        if (imm == null) return;
