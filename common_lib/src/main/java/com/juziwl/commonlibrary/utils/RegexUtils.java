...
public final class RegexUtils {
    ...
    /**
     * 匹配链接和电话号码（包括手机号码和固定电话）的正则表达式
     */
    public static Pattern getLinkOrMobilePattern() {
        return Pattern.compile("(((http[s]{0,1}|ftp)://){0,1}[a-zA-Z0-9\\.\\-]+\\.([a-zA-Z]{2,4})(:\\d+)?(/[a-zA-Z0-9\\.\\-~!@#$%^&*+?:_/=<>]*)?)" +
                "|(www.[a-zA-Z0-9\\.\\-]+\\.([a-zA-Z]{2,3})(:\\d+)?(/[a-zA-Z0-9\\.\\-~!@#$%^&*+?:_/=<>]*)?)" +
