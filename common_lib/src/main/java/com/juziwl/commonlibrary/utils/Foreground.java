...
public class Foreground implements Application.ActivityLifecycleCallbacks {
    ...
    public void onActivityResumed(Activity activity) {
        if (onChangeListener!=null&& !foreground) {
            onChangeListener.change(true);
        }
        paused = false;
        foreground = true;
        if (check != null) {
    ...
    public void setOnChangeListener (OnChangeListener onChange) {
    ...
    public interface OnChangeListener {
        void change(boolean isForeground);
    }
}
